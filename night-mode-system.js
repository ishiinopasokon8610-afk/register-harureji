...
function classifyElementForNightMode(el) {
    ...
    const needsBgOverride = currentForceMode === 'dark'
        ? (isPlainLightBackground(cs.backgroundColor) || isPlainLightBackgroundImage(cs.backgroundImage))
        : (isPlainDarkBackground(cs.backgroundColor) || isPlainDarkBackgroundImage(cs.backgroundImage));
